<!DOCTYPE html>
  <html>
    <head>  
      ...
      <title>ĐTTX - Lập trình Web 2</title>
          ...
          <section id="banner">
            <div class="parallax-container">
              ...
              <div class="overlay-content  text-white">
                <div class="container">
                  <h1 class="header-title">Đào tạo từ xa</h1>
                  <div class="meta-media">
                    <div class="single-meta">
                      Học kỳ 1 (2018-2019) </br>
                      [Vùng 2]
                    </div>
                  </div>
                </div>
          ...
          <section id="blog-details">
            <div class="container">
              <div class="row">
                ...
                <div class="col s12 m8 l8 swith-to-left display-4">
                  [Vùng 4]
                </div>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col s12">
                    <div class="footer-inner">
                      ...
                      <p class="design-info">&copy;2018 1888180 - Lữ Thị Thùy Trang></p>
                    </div>
                  </div>
                </div>
              </div>
